...
1. Import one image process with the annotation using the region shape
2. Save it by presing Enter and add a label (region aatributes)
...
After training is complete run the prediction script in the same folder and make sure to select the correct .h5 file.
