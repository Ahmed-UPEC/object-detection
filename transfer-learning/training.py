...
class ThreeDataset(mrcnn.utils.Dataset):
...
class GunConfig(mrcnn.config.Config):
    NAME = "three_cfg"
...
# Train
train_dataset = ThreeDataset()
train_dataset.load_dataset(dataset_dir='kangaroo-transfer-learning/data', is_train=True)
train_dataset.prepare()

# Validation
validation_dataset = ThreeDataset()
validation_dataset.load_dataset(dataset_dir='kangaroo-transfer-learning/data', is_train=False)
...
model.train(train_dataset=train_dataset, 
            ...
            learning_rate=gun_config.LEARNING_RATE, 
            epochs=1, 
            layers='heads')
